...
fn scientific_metrics_from_world_metrics(
    ...
    ScientificBenchmarkMetricsResponse {
        ...
        solid_earth_mass_proxy_drift: metrics.solid_earth_mass_proxy_drift,
...
pub(crate) fn get_field(
    ...
    let response = match field_kind.as_str() {
        ...
        "erosion_rate" => FieldResponse {
            field_kind,
            stride,
            cell_count: world_ref.state.hydrology.erosion_rate.len() as u32,
            sampled_count: sampled_len(world_ref.state.hydrology.erosion_rate.len(), stride),
            f32_data: Some(sample_f32(&world_ref.state.hydrology.erosion_rate, stride)),
            u32_data: None,
            i32_data: None,
        },
