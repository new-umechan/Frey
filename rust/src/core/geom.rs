pub(super) fn normalize(v: &mut [f32; 3]) {
...
pub(super) fn mul3(v: [f32; 3], s: f32) -> [f32; 3] {
    [v[0] * s, v[1] * s, v[2] * s]
}
...
pub(super) fn chord_distance(a: [f32; 3], b: [f32; 3]) -> f32 {
    length3(sub3(a, b))
}

pub(super) fn clamp(v: f32, lo: f32, hi: f32) -> f32 {
    if v < lo {
        lo
    } else if v > hi {
        hi
