...
pub(super) fn rng_from_seed(seed: &str, params: &TerrainParams) -> DeterministicRng {
    let canonical = format!(
        "{{\"l_max\":{},\"alpha\":{:.8},\"num_plates_min\":{},\"num_plates_max\":{},\"ocean_plate_ratio\":{:.8},\"boundary_band\":{:.8},\"boundary_convergent_base_gain\":{:.8},\"boundary_divergent_base_gain\":{:.8},\"boundary_transform_relief_gain\":{:.8},\"trench_gain\":{:.8},\"arc_gain\":{:.8},\"collision_gain\":{:.8},\"rift_gain\":{:.8},\"boundary_width_trench\":{:.8},\"boundary_width_arc\":{:.8},\"boundary_width_collision\":{:.8},\"boundary_width_rift\":{:.8},\"boundary_obliquity_mix\":{:.8},\"boundary_distance_falloff\":{:.8},\"boundary_anisotropy\":{:.8},\"smooth_iter\":{},\"smooth_lambda\":{:.8},\"river_rain_base\":{:.8},\"river_accum_threshold\":{:.8},\"erosion_iter\":{},\"hydraulic_erode_rate\":{:.8},\"hydraulic_deposit_rate\":{:.8},\"sediment_capacity_gain\":{:.8},\"erosion_min_slope\":{:.8},\"erosion_max_delta_per_iter\":{:.8},\"coastal_deposit_rate\":{:.8},\"shallow_sea_floor\":{:.8}}}",
        params.l_max,
        params.alpha,
        ...
        params.boundary_convergent_base_gain,
        params.boundary_divergent_base_gain,
        params.boundary_transform_relief_gain,
        params.trench_gain,
        params.arc_gain,
        params.collision_gain,
        params.rift_gain,
        params.boundary_width_trench,
        params.boundary_width_arc,
        params.boundary_width_collision,
        params.boundary_width_rift,
        params.boundary_obliquity_mix,
        params.boundary_distance_falloff,
