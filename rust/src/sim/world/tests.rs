...
fn metrics_are_deterministic_for_fixed_seed() {
    ...
    let mut world_a = World::new(
        ...
        GeologyState {
            ...
            plate_id: plate_id_a,
            plate_emergence_regime: terrain_a.plate_emergence_regime,
            plate_emergence_fallback: terrain_a.plate_emergence_fallback,
            initial_plate_kinematics: terrain_a.initial_plate_kinematics,
    ...
    let mut world_b = World::new(
        ...
        GeologyState {
            ...
            plate_id: plate_id_b,
            plate_emergence_regime: terrain_b.plate_emergence_regime,
            plate_emergence_fallback: terrain_b.plate_emergence_fallback,
            initial_plate_kinematics: terrain_b.initial_plate_kinematics,
...
fn river_network_persists_without_early_collapse() {
    ...
    let mut world = World::new(
        ...
        GeologyState {
            ...
            plate_emergence_regime: terrain.plate_emergence_regime,
            plate_emergence_fallback: terrain.plate_emergence_fallback,
            initial_plate_kinematics: terrain.initial_plate_kinematics.clone(),
            volcanism: vec![0.0; positions.len()],
            vertex_buoyancy: vec![0.0; positions.len()],
            geology_internal: vec![
                crate::sim::geology_types::GeologyInternal::default();
