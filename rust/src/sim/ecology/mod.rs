...
const TREE_GROWTH_RATE: f32 = 0.18;
const TREE_DECLINE_RATE: f32 = 0.08;
const GROUND_GROWTH_RATE: f32 = 0.16;
const GROUND_DECLINE_RATE: f32 = 0.08;
const DISTURBANCE_UP_RATE: f32 = 0.22;
const DISTURBANCE_DOWN_RATE: f32 = 0.10;
const ALPINE_THRESHOLD: f32 = 0.72;
const TUNDRA_THRESHOLD: f32 = -2.5;
const DESERT_THRESHOLD: f32 = 220.0;
const WETLAND_THRESHOLD: f32 = 0.58;
const WETLAND_TREE_THRESHOLD: f32 = 0.55;
const TROPICAL_TEMP_THRESHOLD: f32 = 22.0;
const BOREAL_TEMP_THRESHOLD: f32 = 6.0;
